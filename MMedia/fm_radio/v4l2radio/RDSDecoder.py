...
class RDSDecoder(object):
    ...
    def reset(self):
        ...
        self.__running = True #self.start()
    ...
    def __parsing_loop(self):
        ...
        while self.__running:
            self.__current_group = {}
            #print( 'RDSDecoder is in __parsing_loop while' )
            with self.radio.deviceLock:            
                for i in range(0, 4):
                    ...
                    if not self.__running:
                        break
            #print( 'RDSDecoder finished the __parsing_loop inner while and will sleep' )    
            time.sleep( 0.01 )

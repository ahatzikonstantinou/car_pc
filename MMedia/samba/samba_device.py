...
class SambaDevice( Filesystem ):
	DEBUG = True
	def __init__( self, gio_mount, root_dir, abstract_device, GetSelectedListFilesCallback = None, SetPlaylistLabelTextCallback = None, GetSelectedPlaylistItemsCallback = None ):

...
class BaseService(object):
    ...
    def __init__(self, id, serv_type, url_base, call_headers={}):
        ...
        self.call_headers = call_headers
        self.device = None 	# device using this service
...
class BaseStateVariable(object):
    ...
    def __init__(self, service, name=None, send_events=False, multicast=False,
        data_type=None, values=None):
    ...
    def update(self, value):
        ...
        if self._value == value:
            log.debug("Don't update state variable %s. Same value." % self.name)
            return

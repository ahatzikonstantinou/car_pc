...
from brisa.upnp.base_service import BaseService, BaseStateVariable,\
                                    format_rel_url
from brisa.upnp.control_point.action import Action
...
class Service(BaseService):
    ...
    def __init__(self, id, serv_type, url_base, scpd_url,
                 ...
                 build_async=False, async_cb=None, build=False, call_headers={}):
        """
        ...
        @param call_headers: in case it is necessary to pass fields in the soap
                        headers of each call.
        """
        BaseService.__init__(self, id, serv_type, url_base, call_headers)
        self.event_sid = ''
    ...
    def generate_soap_service(self):
        ...
        self._soap_service = SOAPProxy(ctrl_url, namespace, self.call_headers)

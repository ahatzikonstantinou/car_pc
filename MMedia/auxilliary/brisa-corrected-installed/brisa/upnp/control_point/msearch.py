...
class MSearch(object):
    ...
    def double_discover(self, search_type=DEFAULT_SEARCH_TYPE,
        ...
        """
        log.info("Doing double discover for %s, HTTP_VERSION=%s, MAN=%s, MX=%d, additionals=%s" % (search_type, http_version, man, mx, additionals))
        self.discover(search_type, http_version, man, mx, additionals)

    def discover(self, search_type=DEFAULT_SEARCH_TYPE, http_version="1.1", man='"ssdp:discover"', mx=1, additionals={}):

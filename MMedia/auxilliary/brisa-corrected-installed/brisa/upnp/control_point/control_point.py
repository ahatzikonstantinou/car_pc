...
class ControlPoint(object):
    ...
    def start_search(self, interval, search_type="ssdp:all", reset=False,
        http_version="1.1", man='"ssdp:discover"', mx=1, additionals={}):
        ...
        in the end of the m-search message (default is a empty dictionary)
        ...
        self._msearch.start(interval, search_type, http_version, man, mx, additionals)
    ...
    def force_discovery(self, search_type="ssdp:all", http_version="1.1",
        ...
        @type additionals: dict
        """
        self._msearch.double_discover(search_type, http_version, man, mx, additionals)
    ...
    def _removed_device_event(self, device_info):
        ...
        if udn in self._known_devices:
            log.info('Device is gone: %s' % self._known_devices[udn].friendly_name)

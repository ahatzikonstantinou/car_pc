...
class DeviceBuilder:
	...
	def __init__( self, dev_media_functions, mmedia_gui, error_reporter, message_reporter, publisher_text_display_message_name, GetSelectedListFilesCallback, SetPlaylistLabelTextCallback, GetSelectePlaylistItemsCallback, GetSelectedSystemPlaylistItemsCallback, playerLock, a2dp_provider ):#, DeviceAddedCallback, DeviceRemovedCallback ):
	...
	def DVDFromMount( self, gio_mount ):
		return DVDDevice(
			...
			GetSelectePlaylistItemsCallback = self._GetSelectePlaylistItemsCallback
		)

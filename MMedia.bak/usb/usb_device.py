...
class USBDevice( Filesystem ):
	DEBUG = True
	def __init__( self, gio_mount, uuid, root_dir, abstract_device, GetSelectedListFilesCallback = None, SetPlaylistLabelTextCallback = None, GetSelectePlaylistItemsCallback = None ):
